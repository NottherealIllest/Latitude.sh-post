...
This tutorial will guide you through setting up an Avalanche node on  [Latitude)](https://latitude.sh/ target=”_blank”). Latitude provides high performance lighting fast bare metal servers to ensure that your node is highly secure, available, and accessible.
